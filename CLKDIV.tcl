...
write -f ddc -hierarchy  -output ./${TRIAL_DIR}/mapped/fll_postsyn.ddc
...
write -format verilog -hier -o ./${TRIAL_DIR}/netlists/gf22_fll.v
...
sh date
sh echo "Current git version is `git rev-parse --short HEAD`"
sh echo "Synthesis of CLKDivider has finished."
start_gui
